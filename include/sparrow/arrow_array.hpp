...
namespace sparrow
{
    ...
    concept valid_type_for_arrow_array_buffer = (std::ranges::input_range<T>
                                                ...
                                                || ((mpl::is_type_instance_of_v<T, nonstd::value_ptr>)
                                                    && (sparrow::is_arrow_base_type<typename T::element_type>) );
    ...
    struct arrow_array_private_data
    {
        ...
        [[nodiscard]] any_data_container& buffers() noexcept;

        template <class T>
        [[nodiscard]] const T** buffers_ptrs() noexcept;

        [[nodiscard]] any_data_container& children() noexcept;

        [[nodiscard]] ArrowArray** children_ptrs() noexcept;

        [[nodiscard]] any_data& dictionary() noexcept;

        [[nodiscard]] ArrowArray* dictionary_ptr() noexcept;

    private:

        any_data_container m_buffers;
    ...
    template <typename B, typename C, typename D>
        requires(arrow_array_buffers_or_children<B> || valid_type_for_buffer_tuple<B>)
                    && arrow_array_buffers_or_children<C>
    arrow_array_private_data::arrow_array_private_data(B buffers, C children, D dictionary)
    ...
    [[nodiscard]] inline any_data_container& arrow_array_private_data::buffers() noexcept
    {
        return m_buffers;
    }
    ...
    {
        return m_buffers.get<const T>();
    }

    [[nodiscard]] inline any_data_container& arrow_array_private_data::children() noexcept
    {
        return m_children;
    }
    ...
    {
        return m_children.get<ArrowArray>();
    }

    [[nodiscard]] inline any_data& arrow_array_private_data::dictionary() noexcept
    {
        return m_dictionary;
    }
    ...
    {
        return m_dictionary.get<ArrowArray>();
    }
