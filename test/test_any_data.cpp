...
TEST_SUITE("any_data")
{
    ...
    TEST_CASE("get")
    {
        SUBCASE("mutable")
        {
            ...
            SUBCASE("std::nullopt_t")
            {
                sparrow::any_data any_data{std::nullopt};
                CHECK_EQ(any_data.get<int>(), nullptr);
            }
        }
        ...
        SUBCASE("const")
        {
            ...
            SUBCASE("std::nullopt_t")
            {
                const sparrow::any_data any_data{std::nullopt};
                CHECK_EQ(any_data.get<int>(), nullptr);
            }
        }
    }
    ...
    TEST_CASE("type_id")
    {
        ...
        {
            sparrow::any_data any_data{nullptr};
            CHECK_EQ(any_data.type_id(), typeid(void));
        }
...
TEST_SUITE("any_data_container")
{
    TEST_CASE("constructors")
    {
        ...
        SUBCASE("std::nullptr_t")
        {
            sparrow::any_data_container data{nullptr};
        }

        SUBCASE("std::nullopt_t")
        {
            sparrow::any_data_container data{std::nullopt};
        }
    }
    ...
    TEST_CASE("get_pointers_vec")
    {
        ...
        {
            sparrow::any_data_container data{nullptr};
            CHECK(data.get_pointers_vec<int>().empty());
        }
    ...
    TEST_CASE("value")
    {
        SUBCASE("mutable")
        {
            ...
            SUBCASE("std::tuple<std::vector<int32_t>, sparrow::buffer<uint8_t>, int64_t*")
            {
                ...
                using tuple_type = std::tuple<std::vector<int32_t>, sparrow::buffer<int64_t>, int64_t*>;
                tuple_type tuple{std::vector<int32_t>{0, 1, 2, 3, 4}, sparrow::buffer<int64_t>(vec), vec.data()};

                sparrow::any_data_container data{tuple};
                auto& data_tuple = data.value<tuple_type&>();
            ...
            {
                sparrow::any_data_container data{nullptr};
                CHECK_THROWS_AS([[maybe_unused]] auto val = data.value<int&>(), std::bad_any_cast);
            }
