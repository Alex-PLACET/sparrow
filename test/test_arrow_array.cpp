    ...
    TEST_CASE("ArrowArray")
    {
        ...
        SUBCASE("make_array_constructor")
        {
            SUBCASE("w/ buffers, unique_ptr children and unique_ptr dictionary")
            {
                ...
                const auto array = sparrow::make_arrow_array(
                    1,
                    0,
                    0,
                    buffers_dummy,
            ...
            SUBCASE("w/ shared_ptr buffers, children and shared_ptr dictionary")
            {
                ...
                const auto array = sparrow::make_arrow_array(1, 0, 0, buffers, children, dictionary);
            ...
            {
                const auto array = sparrow::make_arrow_array(1, 0, 0, buffers_dummy, nullptr, nullptr);
        ...
        {
            auto array = sparrow::make_arrow_array(1, 0, 0, buffers_dummy, nullptr, nullptr);
...
TEST_SUITE("arrow_array_private_data")
{
    TEST_CASE("buffers")
    {
        ...
        auto buffers_ptrs = private_data.buffers_ptrs<int32_t>();
        for (size_t i = 0; i < buffers.size(); ++i)
        {
            for (size_t j = 0; j < buffers[i].size(); ++j)
            {
